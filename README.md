...
- [x] Design the Navbar exactly like the Figma design
- [x] Put your **logo on the left side**
- [x] Put your **navigation links on the right side** — links are: **Home**, **Timeline**, **Stats**
- [x] Each link should have an **icon** next to the text
- [x] The **active page link** should look different (highlighted), just like the Figma design
